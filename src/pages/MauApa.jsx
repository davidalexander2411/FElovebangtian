...
<img src="../public/img/menu bg.png" className="w-full h-full absolute z-0"/>

<img src="../public/img/pg.png" className="absolute z-10 top-10 left-0 w-2/5 h-auto mx-auto right-0"/>
</div>
